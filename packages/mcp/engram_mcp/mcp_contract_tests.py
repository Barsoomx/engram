...
class McpContractTests(unittest.TestCase):
    ...
    def test_tools_list_returns_all_tools(self) -> None:
        ...
        self.assertEqual(
            names,
            ['engram_search', 'engram_context', 'engram_memory_link', 'engram_observations', 'engram_memory_version'],
        )
    ...
    def test_tools_call_memory_version_returns_text_content(self) -> None:
        ...
        self.assertIn('versioned mem-1 body=new body', response['result']['content'][0]['text'])
