...
class RepositoryContractDocumentationTests(unittest.TestCase):
    ...
    def test_historical_outbox_docs_are_superseded_by_package_transport_notes(
        self,
    ) -> None:
    ...
    def test_hook_event_plan_queues_observation_ids_through_package_transport(
        self,
    ) -> None:
        plan = (
            ROOT / "docs/superpowers/plans/2026-06-25-hook-event-coverage.md"
        ).read_text(
            encoding="utf-8",
        )
    ...
    def test_live_evidence_names_package_transport_not_custom_domain_outbox(
        self,
    ) -> None:
        ...
        backend_contracts = (ROOT / "docs/backend-contracts.md").read_text(
            encoding="utf-8"
        )
        operations = (ROOT / "docs/operations-and-deployment.md").read_text(
            encoding="utf-8"
        )
