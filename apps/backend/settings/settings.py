...
ENGRAM_CANDIDATE_REVIEW_TTL_DAYS = int(os.environ.get('ENGRAM_CANDIDATE_REVIEW_TTL_DAYS', '14'))

ENGRAM_CANDIDATE_TTL_BATCH = int(os.environ.get('ENGRAM_CANDIDATE_TTL_BATCH', '500'))
...
ENGRAM_IMPORT_JOB_TTL_HOURS = int(os.environ.get('ENGRAM_IMPORT_JOB_TTL_HOURS', '24'))
